...
public class SignInHelper {
	...
	public static void signIn(HttpSession session, String userName, String userType) {
	...
	public static boolean isAuthorizedUserType(String user, String password, String userType) {
		return new LDAPAuthenticator().authenticateUser(user, password, userType);
	}
	
	/**
	 * @since 5.4 
	 */
	public static boolean isAuthorized(String userName, String password, String userType, Messages errors) {  
		boolean authorized = isAuthorizedUserType(userName, password, userType);
